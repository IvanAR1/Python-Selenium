...
Deprecation = deprecated(reason="All methods in module 'libs.path.path_utlis' are deprecated and deleted in other version. Please, use the module 'libs.path.utils'"
                         ,version="1.0.0")
